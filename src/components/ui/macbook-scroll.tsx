...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className=" min-h-[190vh]  flex flex-col items-center py-0 sm:py-0 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
...
const AceternityLogo = () => {
  return (
    ...
    //   />
    // </svg>
     <div className="text-white" >Satya.dev</div>
  );
};
